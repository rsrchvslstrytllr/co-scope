function Sidebar({ currentStep, setCurrentStep, completedSteps }) {
  ...
  const CohereLogo = () => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 968.1 103.1" style={{ width: '100%', height: 'auto' }}>
      <g fill="#000000ff">
